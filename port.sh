...
sudo port -N install coreutils moreutils findutils bash bash-completion git-flow-bash-completion wget screen pwgen tcpdump aircrack-ng parallel binwalk dns2tcp fcrackzip nmap socat tcptrace mtr git git-lfs python35 python27 mplayer ipcalc ipv6calc pv mtr py27-gnureadline py35-gnureadline python36 py36-gnureadline py36-pip inetutils
